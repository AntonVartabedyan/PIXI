...
export class GameView extends BaseView {
  ...
  protected init() {
    ...
    // EventDispatcher.getInstance().getDispatcher().on(GameEvents.GAME_SHOP, this.hideGameObjects, this);
    // EventDispatcher.getInstance().getDispatcher().on(GameEvents.GAME_SHOP_EXIT, this.showGameObjects, this);
  }
...
// private hideGameObjects(){
//   this.gameObjects.forEach(obj =>{
//     const gfx: PIXI.Graphics = new PIXI.Graphics();
//     if( obj.getId() == "ball" || obj.getId() == "paddle"){
//       return;
//     }else{
...
//      this.square = new PIXI.Sprite(texture1);
//     this.square.mask = obj;
//     // obj.addChild(this.square);
//     }
    
//   });
// }
// private showGameObjects(){
//   this.gameObjects.forEach(obj =>{
//     if( obj.getId() == "ball" || obj.getId() == "paddle"){
//       return;
//     }
//     const gfx: PIXI.Graphics = new PIXI.Graphics();
//     this.square.mask = null;
//     // obj.removeChild(this.square);
//   });
// }
  private activate() {
  ...
  private createPaddle() {
    ...
    const sprite: PIXI.Sprite = PIXI.Sprite.from('../assets/bricks/paddleSprite.png');
    sprite.width = 100;
    sprite.height =20;
