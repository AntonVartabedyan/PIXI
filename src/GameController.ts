...
export class GameController extends PIXI.Container {
        ...
        this.LevelBriefScreen.title.text = "LEVEL "+ Model.getInstance().getCurrentLevel();
                switch(Model.getInstance().getCurrentLevel()){
                    case 1:
                        ...
                        this.LevelBriefScreen.description.text = "BLUE IS MORE MENACING THAN RED";
                        break;
                        case 3:
    ...
    private init() {
        SoundManager.audio.volume = 0.5;
        SoundManager.audio2.volume = 0.5;
    ...
    private updateScore(e: any) {
        ...
        SoundManager.brickSound.volume = 0.3;
