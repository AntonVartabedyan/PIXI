...
export class GameController extends PIXI.Container {
        ...
        this.LevelBriefScreen.title.text = "LEVEL "+ Model.getInstance().getCurrentLevel();
                switch(Model.getInstance().getCurrentLevel()){
                    case 1:
                        ...
                        this.LevelBriefScreen.description.text = "BLUE BRICKS HAVE RED ONES IN THEM";
                        break;
                        case 3:
    ...
    private init() {
        SoundManager.audio.volume = 0.2;
        SoundManager.audio2.volume = 0.2;
        SoundManager.paddleHitSound.volume = 0.2;
        SoundManager.WallHitSound.volume = 0.2;
        SoundManager.brickSound.volume = 0.2;
    ...
    private backgroundMusic(){
        ...
        SoundManager.audio.onended = () => {
            SoundManager.audio2.play();
        }
        SoundManager.audio2.onended = () => {
    ...
    private onKeyUp(e:any) {
        ...
        if(e.keyCode === 38){
            SoundManager.audio.volume +=0.1;
            SoundManager.audio2.volume +=0.1;
            SoundManager.brickSound.volume +=0.1;
            SoundManager.WallHitSound.volume +=0.1;
            SoundManager.paddleHitSound.volume +=0.1;
        }
        if(e.keyCode === 40){
            SoundManager.audio.volume -=0.1;
            SoundManager.audio2.volume -=0.1;
