...
export class Game extends PIXI.Container {
    ...
    private blueSquareBehavior: BlueSquareBehavior;
    private blueCreated: boolean = false;
    ...
    private createBallGameObj() {
        ...
        this.ballBehavior = new BallBehavior(ballGameObj);
        ballGameObj.addBehavior('ballBehavior', this.ballBehavior);
    ...
    private createBlueSquareGameObj() {
        ...
        this.blueSquareBehavior = new BlueSquareBehavior(blueSquareGameObj);

        this.blueSquareBehavior.setBallObjRef(this.getGameObjById('gameObj1'));

        blueSquareGameObj.addBehavior('bluesquareBehavior', this.blueSquareBehavior);
        EventDispacher.getInstance().getDispacher().addListener('updatescore', this.onScoreUpdate, this);
    ...
    public getSquare() {
        ...
        // this.blueSquareBehavior.setBallObjRef(this.getGameObjById('gameObj1'));
        this.ballBehavior.setBlueSquareObjRef(this.getGameObjById("gameObj3"))
    }
    ...
    private onScoreUpdate() {
        ...
        if (!this.blueCreated) {
            ...
            this.getGameObjById('gameObj3').addBehavior('bluesquareBehavior', this.blueSquareBehavior);
            this.getSquare()
            this.blueCreated = true;
        }


        // this.getGameObjById('gameObj2').addBehavior('bluesquareBehavior', new BlueSquareBehavior(this.getGameObjById('gameObj2')));
