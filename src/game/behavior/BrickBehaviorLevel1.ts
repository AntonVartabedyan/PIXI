        ...
        if(e.brickId === this.gameObjRef.getId()){
            ...
            switch (this.hitCount){
                ...
                case 6:
                    ...
                    // this.gameObjRef.registerRenderable('brickImg', sprite2);
                ...
                case 7:
                    ...
                    if(this.hitCountCeramic < 8){
                        if(this.hitCountCeramic > 5){
                            const sprite: PIXI.Sprite = PIXI.Sprite.from('./assets/bricks/brickBroken2.png');
                            ...
                            const sprite: PIXI.Sprite = PIXI.Sprite.from('./assets/bricks/brickBroken.png');
